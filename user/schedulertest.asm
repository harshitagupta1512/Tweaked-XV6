...
int main()
{
  ...
  16:	30a080e7          	jalr	778(ra) # 31c <fork>
    if (pid < 0)
  ...
  36:	68078793          	addi	a5,a5,1664 # 989680 <__global_pointer$+0x9885ef>
      {
  ...
  50:	368080e7          	jalr	872(ra) # 3b4 <sleep>
  ...
  66:	7f650513          	addi	a0,a0,2038 # 858 <malloc+0xe6>
  6a:	00000097          	auipc	ra,0x0
  6e:	64a080e7          	jalr	1610(ra) # 6b4 <printf>
  return 0;
}
  72:	4501                	li	a0,0
  74:	70e2                	ld	ra,56(sp)
  ...
  94:	33c080e7          	jalr	828(ra) # 3cc <waitx>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 424:	46050513          	addi	a0,a0,1120 # 880 <digits>
 428:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f0:	394b8b93          	addi	s7,s7,916 # 880 <digits>
 ...
 630:	24c90913          	addi	s2,s2,588 # 878 <malloc+0x106>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f8:	1a47b783          	ld	a5,420(a5) # 898 <freep>
 ...
 726:	00e6ea63          	bltu	a3,a4,73a <free+0x50>
{
 ...
 768:	12f73a23          	sd	a5,308(a4) # 898 <freep>
}
 76c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 79a:	10253503          	ld	a0,258(a0) # 898 <freep>
 ...
 7c2:	0da90913          	addi	s2,s2,218 # 898 <freep>
  if(p == (char*)-1)
 7c6:	5afd                	li	s5,-1
 7c8:	a88d                	j	83a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ca:	00000797          	auipc	a5,0x0
 7ce:	0d678793          	addi	a5,a5,214 # 8a0 <base>
 7d2:	00000717          	auipc	a4,0x0
 7d6:	0cf73323          	sd	a5,198(a4) # 898 <freep>
 7da:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fc:	0aa73023          	sd	a0,160(a4) # 898 <freep>
      return (void*)(p + 1);
