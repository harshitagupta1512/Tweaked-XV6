...
int main(int argc, char **argv) {
  ...
  16:	7f650513          	addi	a0,a0,2038 # 808 <malloc+0xe8>
  1a:	00000097          	auipc	ra,0x0
  1e:	648080e7          	jalr	1608(ra) # 662 <printf>
        return 1;
  22:	4505                	li	a0,1
  ...
  38:	19e080e7          	jalr	414(ra) # 1d2 <atoi>
  3c:	892a                	mv	s2,a0
    int pid = atoi(argv[2]);
  3e:	6888                	ld	a0,16(s1)
  40:	00000097          	auipc	ra,0x0
  44:	192080e7          	jalr	402(ra) # 1d2 <atoi>
  48:	85aa                	mv	a1,a0
    int old = set_priority(new, pid);
  4a:	854a                	mv	a0,s2
  4c:	00000097          	auipc	ra,0x0
  50:	336080e7          	jalr	822(ra) # 382 <set_priority>
    if (old == -1)
  54:	0505                	addi	a0,a0,1
        return 1;
  56:	00a03533          	snez	a0,a0
  5a:	b7e9                	j	24 <main+0x24>
