...
//declare an array of "syscall names" which is used to obtain the syscall name corresponding to syscall num
//get the mask value of the current process to determine whether the currently called syscall is tracked and print out the corresponding information